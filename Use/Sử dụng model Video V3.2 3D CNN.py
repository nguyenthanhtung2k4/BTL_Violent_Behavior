...
output_video_path = "./xuat/output_box.mp4"  # Đường dẫn video đầu ra
output_frame_dir = "./xuat"  # Thư mục lưu các frame ổn định
# ---------------------------
...
img_size = 224 
window_size = 20
model_path = r'D:\CODE\DNU_AI\AI_Leaning\Tenserflow\models\V4dcnn_data2_224_20_optimized.keras'
violence_threshold = 0.74  # Ngưỡng bạo lực
