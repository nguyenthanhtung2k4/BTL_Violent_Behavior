...
# ---------------------------
# HIỂN THỊ VIDEO VÀ LƯU VIDEO VỚI OVERLAY DỰ ĐOÁN
# ---------------------------
def display_and_save_video_with_async_prediction(video_path, output_path):
    ...
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Hoặc sử dụng 'XVID' cho định dạng .avi
    ...
    while True:
        ...
        # Hiển thị và lưu frame vào video đầu ra
...
output_video_path = r'xuat/camera_2D_112_20.mp4'  # Đường dẫn lưu video đầu ra
display_and_save_video_with_async_prediction(video_path, output_video_path)
