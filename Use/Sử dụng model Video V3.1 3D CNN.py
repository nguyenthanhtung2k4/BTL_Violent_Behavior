...
video_path = "./data_test/box.mp4"  # Thay bằng đường dẫn video của bạn
output_video_path = "Video3_5s_box_V4_112_20.mp4"  # Thay bằng đường dẫn video của bạn
# ---------------------------
...
model_path = r'D:\CODE\DNU_AI\AI_Leaning\Tenserflow\models\V4dcnn_data2_112_20_optimized.keras'  # Đường dẫn tới mô hình 3D CNN đã train
